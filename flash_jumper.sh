#!/bin/bash
echo "[MONITOR] Esperando a que el pin 9 toque GND al conectar el USB..."
while true; do
    if dmesg | tail -n 10 | grep -iq "3c:dc:75:3a:23:e8"; then
        echo "[BOOTLOADER] 🎯 ¡Modo Bootloader detectado! Grabando..."
